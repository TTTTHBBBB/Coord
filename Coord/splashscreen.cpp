...
SplashScreen *SplashScreen::getInstance()
{
    ...
    {
        QPixmap oldpixmap(":/images/png/coord.svg");
        QPixmap newpixmap = oldpixmap.scaled(500,500,Qt::KeepAspectRatio,Qt::SmoothTransformation);
        m_instance = new SplashScreen(newpixmap);
    }
    return m_instance;
}
